...
const TopFields = () => {
  const services = [
    ...
    },
    {
      ...
      service: "Pop-Singer",
      description:
        "Ayaam club wants a real pop-singer to perform in the upcomming event of Ayaam ,So be the part of it to enroll it now.",
    },
  ];

  return (
    <section className="services">
      <h3>Top Trending Skills/Opportunities in our NITA Campus!</h3>
      <div className="grid">
